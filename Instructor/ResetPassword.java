            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                else
                {
                    ...
                    try {
                        ...
                        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "system", "orcl");
                        String sql = "SELECT * FROM TBLINSTRUCTOR WHERE USER_NAME = ? AND PASSWORD = ?";
                        ...
                        if (rs.next())
                        {
                            try
                            {
                                ...
                                String sql1 ="SELECT a.PASSWORD,b.FIRST_NAME,b.LAST_NAME, b.EMAIL_ID,a.USER_NAME FROM  TBLINSTRUCTOR a, TBLUSERS b WHERE a.USER_NAME = '"+username_field.getText()+"' AND a.USER_ID = b.USER_ID";
        ...
        Register.addActionListener(e ->
        {
            ...
            if(passText.equals(passText_confirm) && !passText.equals(oldpassword1) && !passText_confirm.equals(oldpassword1))
            {
                ...
                try {
                    ...
                    String sql = "UPDATE TBLINSTRUCTOR SET PASSWORD = '" + passText + "' WHERE USER_NAME = '" + Username + "'";
                    ...
                    if(x >0)
                    {
                        ...
                        // Select the username from the tbllogin table where the user id is the same as the user id from the database
                        String sql2 ="SELECT a.USER_NAME,a.PASSWORD,b.FIRST_NAME,b.LAST_NAME, b.EMAIL_ID FROM  TBLINSTRUCTOR a, TBLUSERS b WHERE a.USER_NAME = '"+Username+"' AND a.USER_ID = b.USER_ID";
