...
public class ViewProfileDetails
{
    ...
    // Function to get the user's details from the database using username
    public static String[] findName(String userName)
    {
        ...
        try
        {
            ...
            String query = "SELECT TBLUSERS.FIRST_NAME,TBLUSERS.MIDDLE_NAME,TBLUSERS.LAST_NAME,TBLLOGIN.PASSWORD, tblusers.EMAIL_ID, TBLUSERS.DOOR_NO,TBLUSERS.STR_NAME,TBLUSERS.CITY,TBLUSERS.PINCODE,TBLUSERS.STATE,tblusers.GENDER, tblusers.AGE FROM TBLUSERS INNER JOIN TBLLOGIN ON tblusers.USER_ID = tbllogin.USER_ID WHERE tbllogin.USER_NAME = '" + userName + "'";
             // Execute the query
    ...
    public static String findPhoneNumber(String userName)
    {
        String phone = "";
        try
        {
            ...
            String query = "SELECT TBLUSER_PHONE_NUMBER.PHONE_NUMBER FROM TBLUSER_PHONE_NUMBER INNER JOIN TBLLOGIN ON TBLUSER_PHONE_NUMBER.USER_ID = TBLLOGIN.USER_ID WHERE TBLLOGIN.USER_NAME = '" + userName + "'";
            // Execute the query
            ResultSet rs = stmt.executeQuery(query);
            while (rs.next())
            {
